...
const App = () => {
  ...
  const addTask = (e) => {
    e.preventDefault();
    if (!name) {
      showAlert(true, "Enter Valid Task!");
      ...
      setEditId(null);
      setName("");
      showAlert(true, "Task Edited Sucessfully.");
    } else {
      const newTask = {
        id: uuid().slice(0, 8),
        name: name,
      ...
      showAlert(true, "Task Added Succesfully.");
      setName("");
    }
  };
  ...
  <>
    ...
    <a href='https://github.com/FairozAhmadSheikh' target='_blank' rel="noopener noreferrer"><FaGithub className='github'/></a>
    <p> © Developed by Fairoz Ahmad Sheikh | All rights Reserved</p>
